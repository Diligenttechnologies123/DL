        ...
        <form class="contact_form" id="contact_form" action= "" method = "post">
            ...
            <div class="input_wrap form1">
              <h2>
                ...
                <input type="text" name="inputLastName" id="inputLastName" required>
              </h2>
            </div>
            <div class="input_wrap form2">
              <h2>and I work at <input type="text" name="inputWork" id="inputWork" required></h2>
            </div>
            <div class="input_wrap form3">
              <h2>I need help with <input type="text" name="inputHelp" id="inputHelp" required></h2>
            </div>
            <div class="input_wrap form4">
              <h2>
                Personally, I feel <input type="text" name="inputFeel" id="inputFeel" required> about this
                Project.
              </h2>
            </div>
            <div class="input_wrap form5">
              <h2>Because, I am the <input type="text" name="inputbecause" id="inputbecause" required></h2>
            </div>
            <h2 class="budget">Our Budget is</h2>
            <div class="slidecontainer form-range">
              <input type="text" data-min="10000" data-max="200000" data-from="25000" data-range="" value="" size="40" class="range_slider" readonly="">
            </div>

            <div class="input_wrap form7">
              <h2>and this has to launch <input type="text" name="inputlaunch" id="inputlaunch" required></h2>
            </div>
